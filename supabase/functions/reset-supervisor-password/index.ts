...
serve(async (req) => {
  ...
  try {
    ...
    // Verify the user exists in supervisors
    ...
    console.log(`Password reset successful for supervisor: ${supervisor.email}`);
    ...
    console.error('Error in reset-supervisor-password:', error);
    return new Response(
